...
export default async function mainFlowHandler(req: Request, res: Response): Promise<void> {
  ...
  try {
    ...
    const cinemasNearby: CinemaObject[] = await filterCinemas(radius, encodedCity);
